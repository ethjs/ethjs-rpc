...
All information regarding contributing to and progressing `ethjs-rpc` module can be found in this document.
...
Please help better the ecosystem by submitting issues and pull requests. We need all the help we can get to build the absolute best linting standards and utilities. We follow the AirBNB linting standard. Please read more about contributing to `ethjs-rpc` in the `.github/CONTRIBUTING.md`.
